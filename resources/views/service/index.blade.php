                        ...
                        <table class="table table-striped table-bordered admin-table__adapt admin-table__instrument">
                            ...
                            @forelse($works as $work)
                                <tr>
                                    ...
                                    <td data-label="Дата" class="text-center">{{ date('d.m.Y', $work->created_at) }}</td>
                                    ...
                                    <td data-label="Сервис" class="text-center">{{ $work->service_title ?: ' - ' }}</td>
                                    <td data-label="Пробег" class="text-start">{{ Helper::mileage($work->mileage) }}</td>
                                    <td data-label="Цена" class="text-center">{{ number_format($work->price, 0, '.', ' ') }} р.</td>
